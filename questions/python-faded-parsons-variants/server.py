...
def generate(data):
    ...
    names_from_user = [
        { "name": "stay_focused", "description": "returns a short encouragement string", "type": "python function"},
        { "name": "average", "description": "computes the sum of a list of numbers", "type": "python function"},
    ]
